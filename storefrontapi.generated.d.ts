...
export type CollectionHomeQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type CollectionHomeQuery = {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CollectionHome($handle: String!) {\n    collection(handle: $handle) {\n      id\n      title\n      handle\n      products(first: 8) {\n        nodes {\n          id\n          title\n          handle\n          publishedAt\n          variants(first: 1) {\n            nodes {\n              id\n              availableForSale\n              image {\n                url\n                altText\n                width\n                height\n              }\n              price {\n                amount\n                currencyCode\n              }\n              compareAtPrice {\n                amount\n                currencyCode\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: CollectionHomeQuery;
    variables: CollectionHomeQueryVariables;
  };
