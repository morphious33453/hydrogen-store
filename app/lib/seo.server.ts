...
function home({
  ...
  return {
    title: title ?? 'Home',
    titleTemplate: '%s | Hydrogen Demo Store',
    description: description ?? 'The best place to buy snowboarding products',
    url,
    robots: {
      noIndex: false,
      noFollow: false,
    ...
    jsonLd: [
      ...
      },
      {
        '@context': 'https://schema.org',
        '@type': 'Organization',
        name: 'CAN-TAP Verified',
        url: 'https://cantap.ca',
        logo: 'https://cantap.ca/logo-new.png',
        sameAs: [
          'https://instagram.com/cantap_ca',
          'https://facebook.com/cantap_ca'
        ],
        contactPoint: {
          '@type': 'ContactPoint',
          telephone: '+1-555-555-5555', // Placeholder, user to update
      ...
      },
      {
        '@context': 'https://schema.org',
        '@type': 'Product',
        name: 'CAN-TAP Verified Enterprise Kit',
        image: 'https://cantap.ca/logo-new.png', // Needs actual product image
        description: 'The official NFC tap-to-review system for Canadian businesses. Includes acrylic stand, window decal, and lifetime warranty.',
        brand: {
          '@type': 'Brand',
          name: 'CAN-TAP Verified'
        },
